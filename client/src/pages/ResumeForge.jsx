            ...
            <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
                  ...
                  <div className="flex items-center">
                    {activeSectionIndex !== 0 && (
                      <button
                        ...
                        className="flex items-center gap-1 p-3 rounded-lg test-sm font-medium text-grat-600 hover:bg-gray-50 transition-all disabled:{activeSectionIndex === 0}"
                      >
                ...
                <div>
                  ...
                  <button onClick={() => toast.promise(saveResume(), { loading: 'Saving...' })} className="bg-linear-to-br from-indigo-100 to indigo-200 ring-indigo-300 text-indigo-600 ring hover:ring-indigo-400 transition-all rounded-md px-6 py-2 mt-6 text-sm">
                    Save Changes
                  </button>
                </div>
              </div>
